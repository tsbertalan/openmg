...
def main(N):
    ...
    print N, "direct", np.linalg.norm(soln - u_true), elapsed
    ...
    if N <= 200:
        ...
        elapsed = time() - a
        print N, "Gauss-Seidel", np.linalg.norm(soln - u_true), elapsed
    ...
    elapsed = time() - a
    #print params
    print N, "%i-grid"%g, np.linalg.norm(soln - u_true), elapsed
